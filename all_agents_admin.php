...
$query = "select *from agent_login";
  ...
  while($row=mysqli_fetch_array($run)){
    ...
    <div class='panel-body' style='height:180px;box-shadow:5px 5px 5px 5px ;'>
      <div class='table'>
      <style>
      a{
           color:black;
...
<a href='agent_delete_admin.php?delete=$agent_id'style='color:white;text-decoration:none;'>Delete</a></button>
      <button class='btn btn-success'>
<a href='edit_agent_admin.php?edit_agent=$agent_id' style='color:white;text-decoration:none;'>Edit</a></button>
<button class='btn btn-success' style='margin-left:15%;'>
<a href='agent_details.php?detail=$agent_id' style='color:white;text-decoration:none;'>Details</a>
      </button>
      </td>
      </tr>
