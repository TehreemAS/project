...
$query = "select *from company_login";
  ...
  while($row=mysqli_fetch_array($run)){
    ...
    <button class='btn btn-success'>
      <a href='delete_company_admin.php?delete=$company_id' style='color:white;text-decoration:none;'>Delete</a></button>
      <button class='btn btn-success'>
      <a href='edit_company_admin.php?edit_company=$company_id' style='color:white;text-decoration:none;'>Edit</a></button>
      <button class='btn btn-success'>
      <a href='details_company_admin.php?detail=$company_id' style='color:white;text-decoration:none;'>Details</a></button>
      </td>
