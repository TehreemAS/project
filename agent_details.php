...
$query = "select *from agent_login where agent_id='$view_detail'";
...
<div class="container" style="width: 100%;">
	<h1 style="text-align: center;background-color: black;color: white;">AGENT  DETAILS</h1>
<div class="row"> 
	<div class="col-md-8 col-md-offset-2">
    <div class="panel" style="border:0px;">
      <div class="panel-heading bg-primary">
        <h1 style="text-align: center;font-family: calibari;font-weight: bold;"><?php echo $agent_name;?></h1>
      </div>
      ...
      <div class="panel-body">
        ...
        <table  style="background-color: black;width: 100%;">
          <tr><td><h3>EMAIL</h3></td>
            <td colspan="3"><h3><?php echo $agent_email;?></h3></td>
          </tr>
            
          <tr>
            <td><h3>Contact</h3></td>
            <td><p><?php echo $agent_phone;?></p></td>
          </tr>
        </table>
      </div>
    </div>
